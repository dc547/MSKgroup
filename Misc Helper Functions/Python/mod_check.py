# -*- coding: utf-8 -*-
"""
Program that can be executed to report whether particular
python packages/module is available on the system.
...
def test_pylab():
    ...
    pylab.title ("plot for testing purposes")   
    pylab.legend()
    pylab.xlabel('x')
...
def test_btk():
    try:
        import btk
            ...
            print("Could not import 'btk' -> fail")
            return None
    print("-> btk OK")
